...
public class TambahPengeluaranFragment extends android.app.Fragment implements DatePickerDialog.OnDateSetListener{
    ...
    public TambahPengeluaranFragment(Context context, CreateDatabaseHandler db, TextView mToolBarTextView){
    ...
    public View onCreateView(LayoutInflater inflater, final ViewGroup container, Bundle savedInstanceState) {
        View rootView = inflater.inflate(R.layout.tambah_pengeluaran, container, false);


        //set fragment aktif
        Global lokasiFragment =  Global.getInstance();
        lokasiFragment.setLokasiFragmentAktif(lokasiFragment.tambahPengeluaranFragment);

        //init komponen
        judul = (MaterialEditText) rootView.findViewById(R.id.judul_pengeluaran);
        jumlah = (MaterialEditText) rootView.findViewById(R.id.jumlah_pengeluaran);
        deskripsi = (MaterialEditText) rootView.findViewById(R.id.deskripsi_pengeluaran);
        date = (MaterialEditText) rootView.findViewById(R.id.tanggal_pengeluaran);
        show_date = (ImageButton) rootView.findViewById(R.id.show_tanggal);
        submit = (FButton) rootView.findViewById(R.id.submit_pengeluaran);
        ...
        show_date.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dpd = DatePickerDialog.newInstance(
                        TambahPengeluaranFragment.this,
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(kalkulasiValue()){
                    db.tambahPengeluaran(new Pengeluaran(judul.getText().toString(), deskripsi.getText().toString(), jumlah.getText().toString(), tanggal, bulan, tahun));
                    Toast.makeText(context, "Catatan pengeluaran disimpan", Toast.LENGTH_LONG).show();
                    mToolBarTextView.setText(new Statik().JUDUL_LIST_PENGELUARAN);
